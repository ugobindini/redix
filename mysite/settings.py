...
SECRET_KEY = 'django-insecure-$s^16ba$pgd!vy$@lv9n#+)*gc21r$3v*u#@bx#=xfykp_xh72'
...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
	'django.contrib.sessions', 'django.contrib.messages', 'django.contrib.staticfiles', 'redix']
